...
The updated `monitor-oscar.sh` and `monitor-oscar.bat` wrappers now include single-instance protection so a second live monitor launch is refused until the first one is stopped.
